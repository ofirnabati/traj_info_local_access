...
python run.py -m name=tip_short_lava alg=tip num_iters=1000 eval_frequency=100 env=short_lava_path eigmpc.num_iters=6 test_mpc.num_iters=6 seed="range(5)" hydra/launcher=joblib
python run.py -m name=latip_short_lava alg=latip num_iters=1000 eval_frequency=100 env=short_lava_path eigmpc.num_iters=6 test_mpc.num_iters=6 seed="range(5)" hydra/launcher=joblib
python run.py -m name=otip_short_lava alg=otip num_iters=200 eval_frequency=20 env=short_lava_path eigmpc.num_iters=6 test_mpc.num_iters=6 seed="range(5)" hydra/launcher=joblib
